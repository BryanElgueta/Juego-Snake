document.addEventListener('DOMContentLoaded', () => {
    ...
    const startGame = () => {
        ...
        grid.style = (stopGame ? "background-color:rgb(8, 122, 8)" : "background-color:rgb(3,37,131)")
    }
    ...
    const moveOutcomes = () => {
        if (
            ...
            if (lives == 0) {
                score = 0
                livesDisplay.innerText = "Tienes 0 vidas"
                lives = 3
    ...
    grid.addEventListener('click', () => {
        if (!stopGame)
            ...
            interval = setInterval(moveOutcomes, intervalTime)
        grid.style = (stopGame ? "background-color:rgb(3,37,131)" : "background-color:rgb(8,122,8)")
